...
rapp.controller('productDetailCtrl',['$scope', '$location', 'searchService','memService', 'cartService',
    ...
    if(!$scope.productDetails) {
		searchService.searchById($location.path().split("/")[2]).then(function(data) {
