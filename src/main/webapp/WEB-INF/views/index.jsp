...
<title>EStore</title>
<link rel="stylesheet"
	href="resources/styles/bootstrap-3.3.7/css/bootstrap.min.css" />
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<button type="button" class="navbar-toggle collapsed"
					data-toggle="collapse" data-target="#estore-navbar-collapse-1"
					aria-expanded="false">
					<span class="sr-only">Toggle navigation</span> <span
						class="icon-bar"></span> <span class="icon-bar"></span> <span
						class="icon-bar"></span>
				</button>
				<a class="navbar-brand" href="#/"> EStore Logo </a>
			</div>
				...
				<div class="input-group">
					<div class="input-group-btn">
						...
						<ul class="dropdown-menu" aria-labelledby="dropdownMenuCategories">
							<li ng-repeat="cat in catList"><a
								ng-click="catClick(cat.categoryName)">{{cat.categoryName}}</a></li>
						</ul>
					</div>
...
<<<<<<< HEAD
	...
	<script
		src="https://ajax.googleapis.com/ajax/libs/angularjs/1.5.8/angular-sanitize.js"></script>
	<script
		src="https://angular-ui.github.io/bootstrap/ui-bootstrap-tpls-2.2.0.js"></script>
	...
	<script src="resources/scripts/cartCtrl.js"></script>
	<!-- login module -->
	...
	<script
		src="resources/scripts/modules/payment/directives/creditDirective.js"></script>
...
>>>>>>> ed4dfc717e8b0df61ac073e3a3fbcefe41eb0a99
